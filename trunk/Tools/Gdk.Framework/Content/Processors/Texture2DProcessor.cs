...
namespace Gdk.Content
{
    public class Texture2DProcessor : Processor    
    {
        ...
        public override void Process()
        {
            ...
            Context.LogVerbose("PixelFormat: " + pixelFormat.ToString());
            ...
            if(imageScale != 1.0f)
            {
                ...
                Context.LogVerbose("Scaling image by [" + imageScale + "].  Old Size:[" + surface.Width + "," + surface.Height + "]  New Size:[" + newWidth + "," + newHeight + "]");
            ...
            {
                Context.LogVerbose("Color keying the image");
