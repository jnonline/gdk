...
// ===================================================================================
// In-Place View / Projection
// ===================================================================================

// ***********************************************************************
Matrix3D& Matrix3D::LookAt(const Vector3& position, const Vector3& target, const Vector3& up)
{
...
// ***********************************************************************
Matrix3D& Matrix3D::PerspectiveFOV(float fov, float aspectRatio, float nearDistance, float farDistance)
{
	// Assume:  0 < fov < PI
	// Assume:  near > 0
	// Assume:  far > 0
...
// ***********************************************************************
Matrix3D& Matrix3D::Ortho(float width, float height, float nearPlane, float farPlane)
{
...
// ***********************************************************************
Matrix3D& Matrix3D::OrthoOffCenter(float left, float right, float bottom, float top, float nearPlane, float farPlane)
{
